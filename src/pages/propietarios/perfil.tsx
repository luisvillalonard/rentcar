                ...
                <Col lg={10} md={10} xs={12} className="mx-auto">
                    <Row>
                        ...
                        <Col md="auto" xs="auto" className="align-self-center mb-3">
                            <Button type="submit" variant="primary" className="rounded-pill" form="formpropietario">Actualizar</Button>
                        </Col>
                    </Row>
                                ...
                                <Row className="mb-3">
                                    <Form.Group as={Col} xs={12} className="mb-4 position-relative">
                                        ...
                                        <Form.Select
                                            ...
                                            className="border-0 border-bottom rounded-0"
                                            required
                                            value={entidad?.municipio?.provincia?.id}
